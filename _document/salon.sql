...
-- -----------------------------------------------------
-- Table `dbsalon`.`Employee`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbsalon`.`Employee` ;

CREATE TABLE IF NOT EXISTS `dbsalon`.`Employee` (
...
CREATE TABLE IF NOT EXISTS `dbsalon`.`Service` (
  ...
  INDEX `fk_Service_Employee1_idx` (`Employee_id_employee` ASC) ,
  CONSTRAINT `fk_Service_Employee1`
    FOREIGN KEY (`Employee_id_employee`)
    REFERENCES `dbsalon`.`Employee` (`id_employee`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbsalon`.`planning` (
  ...
  `Admin-salon_id_admin` INT NOT NULL,
  PRIMARY KEY (`id_planning`, `Service_id_Service`, `Admin-salon_id_admin`),
  INDEX `fk_reservation_Service1_idx` (`Service_id_Service` ASC) ,
  INDEX `fk_planning_Client1_idx` (`Client_id_client` ASC) ,
  INDEX `fk_planning_Admin-salon1_idx` (`Admin-salon_id_admin` ASC) ,
  ...
  CONSTRAINT `fk_planning_Admin-salon1`
    FOREIGN KEY (`Admin-salon_id_admin`)
    REFERENCES `dbsalon`.`Admin-salon` (`id_admin`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dbsalon`.`produit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbsalon`.`produit` ;

CREATE TABLE IF NOT EXISTS `dbsalon`.`produit` (
...
CREATE TABLE IF NOT EXISTS `dbsalon`.`Facture` (
  ...
  PRIMARY KEY (`id_Facture`, `produit_id_produit`),
  INDEX `fk_Facture_Client1_idx` (`Client_id_client` ASC) ,
  INDEX `fk_Facture_produit1_idx` (`produit_id_produit` ASC) ,
  ...
  CONSTRAINT `fk_Facture_produit1`
    ...
    REFERENCES `dbsalon`.`produit` (`id_produit`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
