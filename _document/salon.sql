...
CREATE TABLE IF NOT EXISTS `dbsalon`.`Employee` (
  ...
  `employee_nom` VARCHAR(45) NOT NULL,
  `prenom_employee` VARCHAR(45) NOT NULL,
  `adresse_employee` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dbsalon`.`planning` (
  ...
  `Admin-salon_nom` VARCHAR(45) NULL,
