...
<body>
     <div class="frame">
     <img src="./assets/img/16produit.jpg" alt="produits" style=" width:610px; height:480px">
     <img src="./assets/img/Rproduits.jpg" alt="produits" style=" width:610px; height:480px">
     <img src="./assets/img/meches6844.jpg" alt="produits" style=" width:610px; height:480px">
...
<p><span style="font-family:Tahoma;">Dans le souci de votre satisfaction, votre coiffeuse vous propose des <a class="inherit-links" href="index.php?page=salon/nos-produits"><span style="color:#ffffff;"><strong><u>produits</u></strong></span></a> de qualit&eacute; pour prendre soin&nbsp;de votre chevelure.</span></p>
