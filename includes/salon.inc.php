                ...
                <nav class="mobile-menu" data-id="mobile-menu" data-interaction="click" data-toggle-type="type-1" aria-label="Menu hors-champ">
                    <ul id="menu-principal-i-1" class="">
                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2052">
                            <a href="index.php?page=salon/prestations-femme" class="ct-menu-link">Prestations Femme</a>
                        </li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2053">
                            <a href="index.php?page=salon/prestations-homme" class="ct-menu-link">Prestations Homme</a>
                        </li>
                    </ul>
                </nav>
